...
type StatusDialogState = {
  action: StatusAction;
  member: Pick<MemberRecord, 'id' | 'name'>;
};

type EmergencyDialogState = {
  member: Pick<MemberRecord, 'id' | 'name' | 'safeguarding'>;
};
...
export default function MembersPage() {
  ...
  const handleStatusAction = (action: StatusAction, member: Pick<MemberRecord, 'id' | 'name'>) => {
    setStatusDialog({ action, member });
  };

  const handleEmergencyAction = (member: Pick<MemberRecord, 'id' | 'name' | 'safeguarding'>) => {
          ...
          <tbody className="divide-y divide-gray-100 bg-white">
            {members.map((member) => (
              <tr key={member.id} className="transition hover:bg-gray-50">
                <td className="px-4 py-4 text-sm text-gray-600">{member.id}</td>
                ...
                <td className="px-4 py-4 text-sm text-gray-600">{member.otherClubs}</td>
          ...
          >
            <div className="space-y-3">
              ...
              <p id="member-status-dialog-description" className="text-sm leading-6 text-gray-600">
                ...
                {' '}with membership number <span className="font-semibold text-gray-900">{statusDialog.member.id}</span>.
              </p>
            </div>
            ...
            <div className="mt-6 rounded-xl bg-gray-50 p-4 text-sm text-gray-700 ring-1 ring-gray-100">
              ...
              <p className="mt-1">
                <span className="font-medium text-gray-900">Membership number:</span> {statusDialog.member.id}
              </p>
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-gray-900/45 px-4">
          ...
          >
            ...
            <div className="mt-6 grid gap-4 rounded-xl bg-gray-50 p-4 text-sm text-gray-700 ring-1 ring-gray-100 sm:grid-cols-2">
              ...
              <p>
                <span className="font-medium text-gray-900">Membership number:</span> {emergencyDialog.member.id}
              </p>
              <p>
                <span className="font-medium text-gray-900">Emergency contact:</span> {emergencyDialog.member.safeguarding.emergencyContactName}
              </p>
              <p>
                <span className="font-medium text-gray-900">Relationship:</span> {emergencyDialog.member.safeguarding.emergencyContactRelationship}
              </p>
              <p>
                <span className="font-medium text-gray-900">Emergency phone:</span> {emergencyDialog.member.safeguarding.emergencyPhone}
              </p>
              <p>
                <span className="font-medium text-gray-900">Medical conditions:</span> {emergencyDialog.member.safeguarding.medicalConditions}
              </p>
              <p>
                <span className="font-medium text-gray-900">Allergies:</span> {emergencyDialog.member.safeguarding.allergies}
              </p>
              <p>
                <span className="font-medium text-gray-900">Medications:</span> {emergencyDialog.member.safeguarding.medications}
              </p>
              <p className="sm:col-span-2">
                <span className="font-medium text-gray-900">Additional assistance:</span> {emergencyDialog.member.safeguarding.additionalAssistance}
              </p>
            </div>
