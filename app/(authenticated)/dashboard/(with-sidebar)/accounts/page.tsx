  ...
  return (
    <div className="flex min-h-0 flex-1 flex-col overflow-hidden">
      ...
      <div className="min-h-0 flex-1 overflow-y-auto overflow-x-hidden rounded-xl bg-white shadow-sm ring-1 ring-gray-200">
        <table className="w-full table-fixed divide-y divide-gray-200" aria-label="Accounts table">
          <colgroup>
            <col className="w-[16%]" />
            <col className="w-[20%]" />
            <col className="w-[14%]" />
          ...
          <thead className="bg-gray-50">
            <tr>
              ...
              <th aria-hidden="true" role="presentation" className="px-4 py-3" />
            </tr>
          </thead>
                  ...
                  <span
                    className={
                      account.status === 'Active'
                        ? 'inline-flex items-center gap-2 rounded-full border border-emerald-300 bg-emerald-100 px-2.5 py-1 text-xs font-medium text-emerald-800'
                        : 'inline-flex items-center gap-2 rounded-full border border-red-200 bg-red-50 px-2.5 py-1 text-xs font-medium text-red-700'
                    }
                  >
                    <span
                      aria-hidden="true"
